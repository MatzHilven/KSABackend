...
// POST api/event
pub async fn insert(activity: web::Json<EventDTO>, pool: web::Data<Pool>) -> Result<HttpResponse> {
...
// PUT api/event/{id}
pub async fn update(id: web::Path<i32>, activity: web::Json<EventDTO>, pool: web::Data<Pool>) -> Result<HttpResponse> {
